<x-layout>
  <x-slot:tittle>Colection</x-slot>
<div class="bg-white">
  <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 ">
  @foreach ($articles as $article)
  <ul class=" text-black divide-y divide-black-100 my-5">
  <div class="lg:flex lg:items-center lg:justify-between">
  <div class="min-w-0 flex-1">
    <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">{{$article['tittle']}}</h2>
